...
ret , thresh1 = cv2.threshold(resim , 127 , 255 , cv2.THRESH_BINARY) #127 den yukarısını al 127 ortası olur
...
for i in range(6):
    plt.subplot(2 , 3 , i+1) , plt.imshow(resimler[i] , 'gray')#2 satır 3 sutun i+1 cünkü 0dan baslar ,
